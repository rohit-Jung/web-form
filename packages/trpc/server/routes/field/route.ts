...
import { createFieldSchema, updateFieldSchema, reorderFieldsSchema } from "@workspace/services/field/schemas/input"
...
export const fieldRouter = router({
  create: protectedProcedure
    .meta({ openapi: { method: "POST", path: "/fields", tags: TAGS, summary: "Add a field to a form" } })
  ...
  update: protectedProcedure
    .meta({ openapi: { method: "PATCH", path: "/fields/{id}", tags: TAGS, summary: "Update a field" } })
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      if (!form || form.userId !== ctx.user.id) throw new TRPCError({ code: "FORBIDDEN" })
  ...
  delete: protectedProcedure
    .meta({ openapi: { method: "DELETE", path: "/fields/{id}", tags: TAGS, summary: "Delete a field" } })
  ...
  reorder: protectedProcedure
    .meta({ openapi: { method: "POST", path: "/fields/reorder", tags: TAGS, summary: "Reorder fields within a form" } })
