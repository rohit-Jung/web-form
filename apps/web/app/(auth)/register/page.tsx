...
export default function RegisterPage() {
  ...
  const inputClass =
    "h-10 rounded-none border-2 border-black bg-white text-black placeholder:text-black/30 focus-visible:border-[#CC0000] focus-visible:ring-0 dark:border-white/20 dark:bg-zinc-800 dark:text-white dark:placeholder:text-white/30 dark:focus-visible:border-[#CC0000]"
